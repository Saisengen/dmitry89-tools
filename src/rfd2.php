<?php
$title = 'Просроченные номинации к удалению';
...
$query = 'select p.page_namespace, p.page_title, c.cl_sortkey_prefix from ruwiki_p.categorylinks as c, ruwiki_p.page as p where c.cl_to = "Википедия:Просроченные_подведения_итогов_по_удалению_страниц" and c.cl_from = p.page_id and UNIX_TIMESTAMP(c.cl_timestamp) > UNIX_TIMESTAMP("'.date("Y-m-d", $purge).' 00:00:00") order by c.cl_sortkey_prefix';
...
$content = '<p>На данной странице представлены <a href="//ru.wikipedia.org/wiki/Категория:Википедия:Просроченные_подведения_итогов_по_удалению_страниц">просроченные номинации к удалению</a>. Данные актуальны на момент загрузки страницы с поправкой на задержки в синхронизации базы данных.
